let CareerItem = ({ type , place , date , title , data }) =>
{
    ...
    {
        return (
            <div className={`group flex flex-col h-full w-[14.2857%] items-center gap-4 px-2 ${rp} hover:bg-[#B051EE80] ease-in-out duration-500`}>
                <text className='montserrat font-bold text-[#FF5E8A] text-xl text-center'>{title}</text>
                ...
                <text className='montserrat font-bold text-[#FF5E8A] text-xl'>{date}</text>
            </div>
        )
    } else {
        return (
            <div className={`group flex flex-col h-full w-[14.2857%] items-center gap-4 px-2 ${rp} hover:bg-[#FF5E8A80] ease-in-out duration-500`}>
